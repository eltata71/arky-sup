...
5. **Contratos de integración — RESUELTA y DIFERIDA**: habrá integración bidireccional (entrada y salida) con `ardoqq` (gestión de arquitectura), Box (documental) y Confluence (documentación), pero **el usuario la pospuso el 2026-09-12** («para más adelante»). Diseño de referencia en **ADR-008**; no se implementa ni se asume en las fases actuales.

### 7.1 Pendientes todavía

Ninguna decisión de diseño de F1 queda abierta. Las cinco están resueltas (2026-09-12); la quinta queda diferida para implementación.
