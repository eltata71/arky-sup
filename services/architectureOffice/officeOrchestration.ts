...
import { rankSpecialistsForRequest } from './OfficeAgentRouter';
import {
  createHandoff,
  renderHandoffPrompt,
  type HandoffRejection,
} from './agentHandoff';
import type { AgentHandoffKind } from './agentDefinition';
import { workstreamCapableAgents } from './agentRegistry';
import {
  buildConsolidationRefinementPrompt,
  evaluateConsolidation,
  type ConsolidationReview,
} from './officeConsolidationReview';
