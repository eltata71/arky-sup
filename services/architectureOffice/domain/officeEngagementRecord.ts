/**
 * Un encargo de la Oficina tal como se lee y se registra: sus identificadores,
 * la lectura defensiva de lo almacenado y el rastro de auditoría (F6-03,
 * corte 3).
 *
 * Vivía dentro de `OfficeEngagementRepository.ts`, junto a la persistencia. Por
 * eso la fábrica, las transiciones, el comité, el planificador y la
 * reanudación —reglas puras— arrastraban la base de datos al importar
 * `withAuditEntry` o un generador de ids. Aquí no hay E/S: la lectura normaliza
 * un documento cualquiera y nunca lanza, y el rastro se añade como un dato más
 * del encargo.
 */
