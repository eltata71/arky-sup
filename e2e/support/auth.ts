...
/** Sign in through the real UI against the isolated Firebase Auth emulator. */
export async function signInE2E(page: Page): Promise<void> {
  ...
  await expect(page.getByText(/Configuración de Firebase está incompleta/i)).toHaveCount(0);
}
